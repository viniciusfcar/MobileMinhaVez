...
export default function ListaConsultaScreen() {
        ...
        <View style={styles.headerBusca}>
          ...
          <View append>
            <TextInput
              ...
              autoFocus
              placeholder="Ex: nome, status ou especialista"
              autoCapitalize='none'
              keyboardType='text'
              value={busca}
  ...
  const onBusca = async (dado) => {
    ...
    const apiCall = await fetch('https://minhavezsistema.com.br/api/consulta/?search='+dado);
  ...
  const consultas = async () => {
    try {
      ...
      const apiCall = await fetch('https://minhavezsistema.com.br/api/consulta/');
      const response = await apiCall.json();
  ...
  return (
    <View style={styles.container}>
      ...
      <Header style={styles.header}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://www.youtube.com/watch?v=VD8Mdvw8_VQ')}>
